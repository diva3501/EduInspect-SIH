...
function Login() {
	...
	return (
		<>
			<ToastContainer />
			<div className='flex flex-col items-center mb-20 py-2'>
				<div className='flex flex-col justify-center items-center'>
					<h2 className='mt-16 pt-4 text-center text-gray-900 text-2xl font-bold'>
					...
					<div className='bg-blue-50 p-4 rounded-md shadow-md border border-blue-200'>
						<p className='text-sm font-semibold text-blue-700'>
							...
							<span className='font-normal'>
								TechForage@gmail.com
							</span>
						</p>
						<p className='text-sm font-semibold text-blue-700'>
							Password:{' '}
							<span className='font-normal'>teahforage@123</span>
						</p>
					</div>
				</div>
			</div>
